...
class MainActivity : AppCompatActivity() {
    ...
    private fun openFilePicker() {
        ...
        startActivityForResult(intent, REQUEST_OPEN_SRT)
    }

    @Deprecated("Legacy activity result API used for broad Android compatibility.")
    override fun onActivityResult(
        ...
        if (requestCode == REQUEST_OPEN_SRT &&
    ...
    private fun loadSubtitle(uri: Uri) {
        ...
        try {
            ...
            if (content == null) {
                showError("Unable to read subtitle file.")
                return
            }

            subtitles = SubtitleParser.parse(content)

            if (subtitles.isEmpty()) {
                showError("No valid subtitles found.")
                return
            }
    ...
    private fun showCurrentSubtitle() {
        ...
        textSubtitle.text = subtitle.text
